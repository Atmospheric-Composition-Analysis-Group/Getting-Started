...
Similar to Compute2, AWS deployments require loading the environment through module or Spack rather than using pre-built Docker images. Consult the `GCHP operational run script examples`_ for platform-specific setup instructions. quicktest
